...
void main() async {
  ...
  // Init BackgroundService (registers FlutterForegroundTask + local notifications)
  // Must be called before runApp so platform channels are ready
...
class VoidApp extends ConsumerWidget {
  ...
  @override Widget build(BuildContext context, WidgetRef ref) {
    ...
    // WithForegroundTask is required by flutter_foreground_task v8+
    // It provides the Activity reference needed by startService()
