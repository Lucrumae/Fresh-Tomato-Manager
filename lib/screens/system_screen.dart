  ...
  @override Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children:[
        ...
        VCard(padding:const EdgeInsets.all(14), child:Column(children:[
          _ActionRow(
            icon:Icons.bar_chart_rounded, color:V.info,
            title:'Traffic History', subtitle:'Bandwidth usage over time',
            busy:false,
            onTap:()=>Navigator.push(context, MaterialPageRoute(builder:(_)=>const BandwidthScreenWrapper()))),
          Divider(color:v.wire, height:24),
          _ActionRow(
...
class BandwidthScreenWrapper extends StatelessWidget {
  const BandwidthScreenWrapper({super.key});
  @override Widget build(BuildContext ctx) => const BandwidthScreen();
}
