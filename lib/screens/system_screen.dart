...
class _RouterTabState extends ConsumerState<_RouterTab> {
  ...
  Future<void> _backup() async {
    ...
    try {
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('✓ Disimpan ke Download/Tomato Manager/Backup'),
        backgroundColor: V.ok));
    } catch (e) {
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Backup gagal: $e'), backgroundColor: V.err));
  ...
  Future<bool> _ensureStoragePermission() async {
    ...
    // Tampilkan dialog penjelasan sebelum popup OS
      ...
      final proceed = await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            const Text(
              'Tomato Manager membutuhkan akses penyimpanan untuk menyimpan backup config ke:',
            ...
            const SizedBox(height: 10),
            const Text(
              'File backup bisa diakses langsung dari File Manager ponsel Anda.',
      ...
      await showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: const Row(children: [
            ...
            SizedBox(width: 10),
            Text('Izin Diblokir', style: TextStyle(fontSize: 16)),
          ]),
          content: const Text(
            'Izin penyimpanan diblokir secara permanen.\n\n'
            'Buka Pengaturan Aplikasi → Izin → Penyimpanan, lalu aktifkan.',
            style: TextStyle(fontSize: 13, height: 1.5),
          ),
          actions: [
            TextButton(
