...
class _MainShellState extends ConsumerState<MainShell>
  ...
  Future<void> _requestBatteryOptimizationExemption() async {
    try {
      // flutter_foreground_task v8 provides this
      final result = await FlutterForegroundTask.requestIgnoreBatteryOptimization();
      debugPrint('[Shell] Battery optimization exemption: $result');
    } catch (e) {
      debugPrint('[Shell] Battery exemption request: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(data: theme, child: AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WithForegroundTask(child: Scaffold(
