...
class _MainShellState extends ConsumerState<MainShell>
  ...
  Future<void> _boot() async {
    ...
    // Wire SSH into NotificationService for the Disconnect action button
    NotificationService.setSsh(ssh);

    // Keep CPU/WiFi awake so SSH socket + keepalive packets survive background
    ...
    // Request notification permission once, then show connected status
    final granted = await NotificationService.requestPermission();
    if (granted) await NotificationService.showConnected(cfg.host);
