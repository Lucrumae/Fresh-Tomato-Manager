        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Tomato Manager', style: GoogleFonts.outfit(fontSize: 22,
                fontWeight: FontWeight.w900, color: v.hi, letterSpacing: 0.5)),
              Text('FreshTomato SSH Manager', style: GoogleFonts.dmMono(fontSize: 11, color: v.mid)),
            ]),
          ]),
