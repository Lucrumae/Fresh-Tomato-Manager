...
class _SetupScreenState extends ConsumerState<SetupScreen>
  ...
  Future<void> _connect() async {
    ...
    // Android: request battery optimization exemption so SSH stays alive in background.
    // Only show once — skip if already exempted.
    if (Platform.isAndroid) {
      ...
      if (!exempt) {
        ...
        if (userAllowed) {
          // Fire ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS intent directly.
          // This is the ONLY thing done here — no BackgroundService, no WakelockPlus.
          // Those are started in MainShell after navigation is complete.
          try {
