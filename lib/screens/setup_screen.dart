...
class _SetupScreenState extends ConsumerState<SetupScreen>
  ...
  // Check battery optimization — show popup if not yet exempted.
  // Returns true = proceed with connect, false = cancel.
  Future<bool> _ensurePermissions() async {
      ...
      builder: (ctx) {
        ...
        return AlertDialog(
          ...
          title: Row(children: [
            ...
            const Expanded(
              child: Text('Background Permission',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700)),
            ),
          ]),
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            const Text(
              'To keep the SSH connection active when the screen turns off or you switch apps, '
              'Tomato Manager needs to be exempted from battery optimization.',
            ...
            Container(
              ...
              child: Column(children: [
                _PermRow(Icons.wifi_tethering_rounded, v.accent,
                  'Connection stays alive', 'SSH won\'t disconnect when the screen turns off'),
                const SizedBox(height: 8),
                _PermRow(Icons.battery_4_bar_rounded, Colors.orange,
                  'Slightly higher battery usage', 'Only active while connected to the router'),
              ]),
            ),
            ...
            Container(
              ...
              child: const Row(children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text(
                  'An Android system permission dialog will appear next.',
          ...
          actions: [
            TextButton(
              ...
              child: const Text('Skip', style: TextStyle(color: Colors.white38, fontSize: 12)),
            ),
            ElevatedButton.icon(
    ...
    // Regardless of choice (Allow/Skip), proceed with connect
