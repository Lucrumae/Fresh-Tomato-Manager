  ...
  Future<void> _upload() async {
    ...
    try {
      ...
      for (int i = 0; i < b64.length; i += chunkSize) {
        final end = (i + chunkSize).clamp(0, b64.length);
        session.stdin.add(Uint8List.fromList(b64.substring(i, end).codeUnits));
        setState(() => transfer.progress = (0.3 + 0.7 * end / b64.length).clamp(0.0, 0.99));
