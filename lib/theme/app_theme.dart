...
class AppTheme {
  ...
  static ThemeData dark([AccentColor accent = AccentColor.emerald])  => build(true, accent);
  static ThemeData light([AccentColor accent = AccentColor.emerald]) => build(false, accent);
